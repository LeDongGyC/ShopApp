...
export class ProductAdminComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.getProducts(this.keyword,
      ...
      this.currentPage, this.itemsPerPage, this.sort);
  }
  ...
  searchProducts() {
    ...
    debugger
    this.getProducts(this.keyword.trim(), this.selectedCategoryId, this.currentPage, this.itemsPerPage, this.sort);
  }
  ...
  getProducts(keyword: string, selectedCategoryId: number, page: number, limit: number, sort: string) {
    ...
    this.productService.getProducts(keyword, selectedCategoryId, page, limit, sort).subscribe({
      next: (apiResponse: ApiResponse) => {
        debugger
        const products = apiResponse?.data.products as Product[]
